...
4. In questi due ultimi grafici notiamo come gli algoritmi in modalità Release sono più veloci rispetto a quando il codice viene compilato in modalità Debug. Dal grafico relativo alla modalità Release si nota che Insertion Sort rimane mediamente l'algoritmo più efficiente anche se il vettore supera n = 50.
